...
class gsp_coursemanagement_userlogin_gsp extends GroovyPage {
...
invokeTag('form','g',42,['action':("authenticate"),'method':("post")],2)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1418045990000L
