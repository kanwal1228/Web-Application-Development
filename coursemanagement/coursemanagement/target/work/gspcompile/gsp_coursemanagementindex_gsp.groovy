...
class gsp_coursemanagementindex_gsp extends GroovyPage {
...
invokeTag('link','g',92,['controller':("Course")],2)
printHtmlPart(7)
if(true && (session.user != null)) {
printHtmlPart(8)
createClosureForHtmlPart(9, 3)
invokeTag('link','g',94,['controller':("Enrollment")],3)
printHtmlPart(10)
}
printHtmlPart(11)
})
...
public static final long LAST_MODIFIED = 1418116776000L
