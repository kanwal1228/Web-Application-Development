...
class gsp_coursemanagement_userindex_gsp extends GroovyPage {
...
printHtmlPart(8)
invokeTag('message','g',19,['code':("User created with following details")],-1)
printHtmlPart(9)
...
printHtmlPart(12)
invokeTag('paginate','g',25,['total':(userInstanceCount ?: 0)],-1)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1418100414000L
