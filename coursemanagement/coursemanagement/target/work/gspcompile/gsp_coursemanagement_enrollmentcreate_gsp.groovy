...
class gsp_coursemanagement_enrollmentcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/enrollment/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'enrollment.label', default: 'Enrollment'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(enrollmentInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',26,['bean':(enrollmentInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
invokeTag('form','g',34,['url':([resource:enrollmentInstance, action:'save'])],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1418103788000L
