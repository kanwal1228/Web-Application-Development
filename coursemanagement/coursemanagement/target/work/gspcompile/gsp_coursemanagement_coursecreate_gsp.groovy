...
class gsp_coursemanagement_coursecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(courseInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(courseInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:courseInstance, action:'save'])],2)
printHtmlPart(22)
})
