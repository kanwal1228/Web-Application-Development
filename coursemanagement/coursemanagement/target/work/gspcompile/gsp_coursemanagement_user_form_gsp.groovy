...
class gsp_coursemanagement_user_form_gsp extends GroovyPage {
...
printHtmlPart(5)
invokeTag('message','g',25,['code':("user.name.label"),'default':("Name")],-1)
printHtmlPart(2)
invokeTag('textField','g',28,['name':("name"),'required':(""),'value':(userInstance?.name)],-1)
printHtmlPart(6)
}
...
public static final long LAST_MODIFIED = 1418045222000L
