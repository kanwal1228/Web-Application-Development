	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.creditHrs}">
				<li class="fieldcontain">
					<span id="creditHrs-label" class="property-label"><g:message code="course.creditHrs.label" default="Credit Hrs" /></span>
					
						<span class="property-value" aria-labelledby="creditHrs-label"><g:fieldValue bean="${courseInstance}" field="creditHrs"/></span>
